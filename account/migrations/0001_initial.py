# Generated by Django 3.2.12 on 2022-06-03 22:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_num', models.FloatField(blank=True, default=0, unique=True, verbose_name='account num')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='withdraw', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Transfer',
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transfer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
